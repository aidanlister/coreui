...
{{< example >}}
<i class="cil-alarm icon icon-xxl"></i>
...
Referencing an external SVG has the advantage that your icons get cached, with one HTTP request. But the external SVG and the HTML should be served from the same domain.

## CoreUI Icons FREE

A full list of available icons is available on [our website](https://coreui.io/icons/all/).
