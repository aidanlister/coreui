...
{{< example class="docs-example-offcanvas p-0 bg-body-tertiary overflow-hidden" >}}
...
<small class="d-inline-flex px-2 py-1 fw-semibold text-success bg-success bg-opacity-10 rounded-2">Added in v5.0.0-alpha.0</small>
