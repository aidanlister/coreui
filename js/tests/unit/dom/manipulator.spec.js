...
describe('Manipulator', () => {
  ...
  describe('removeDataAttribute', () => {
    it('should only remove coreui-prefixed data attribute', () => {
  ...
  describe('getDataAttributes', () => {
    ...
    it('should get only coreui-prefixed data attributes without bs namespace', () => {
  ...
  describe('getDataAttribute', () => {
    it('should only get coreui-prefixed data attribute', () => {
